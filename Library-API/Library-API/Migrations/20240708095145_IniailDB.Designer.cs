...
namespace Library_API.Migrations
{
    ...
    [Migration("20240708095145_IniailDB")]
    partial class IniailDB
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Library_API.Entity.BookCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Library_API.Entity.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Library_API.Entity.Book", b =>
                {
                    b.HasOne("Library_API.Entity.BookCategory", "BookCategory")
                        .WithMany()
            ...
            modelBuilder.Entity("Library_API.Entity.Order", b =>
                {
                    b.HasOne("Library_API.Entity.Book", "Book")
                        .WithMany()
                        .HasForeignKey("BookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Library_API.Entity.User", "User")
                        .WithMany()
